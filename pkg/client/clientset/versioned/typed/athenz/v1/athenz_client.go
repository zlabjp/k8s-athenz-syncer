...
import (
	v1 "github.com/zlabjp/k8s-athenz-syncer/pkg/apis/athenz/v1"
	"github.com/zlabjp/k8s-athenz-syncer/pkg/client/clientset/versioned/scheme"
...
func (c *AthenzV1Client) AthenzDomains() AthenzDomainInterface {
	return newAthenzDomains(c)
}
